...
ALTER TABLE PROJECT_MANAGER 
    ADD CONSTRAINT FK_ASS_265 FOREIGN KEY 
    ( 
     employee_id
    ) 
    REFERENCES EMPLOYEE 
...
ALTER TABLE CREW_MANAGER 
    ADD CONSTRAINT FK_ASS_266 FOREIGN KEY 
    ( 
     employee_id
    ) 
    REFERENCES EMPLOYEE 
...
ALTER TABLE CONSTRUCTION_WORKER 
    ADD CONSTRAINT FK_ASS_267 FOREIGN KEY 
    ( 
     employee_id
    ) 
    REFERENCES EMPLOYEE 
...
ALTER TABLE SALES_AGENT 
    ADD CONSTRAINT FK_ASS_268 FOREIGN KEY 
    ( 
     employee_id
    ) 
    REFERENCES EMPLOYEE 
