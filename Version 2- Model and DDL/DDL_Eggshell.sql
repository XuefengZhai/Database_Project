...
CREATE TABLE APPLICATION_USER 
    ( 
     ...
     is_active VARCHAR2 (1) DEFAULT 'Y'  NOT NULL CHECK ( is_active IN ('N', 'Y')) 
    ) 
;
...
CREATE TABLE CONTRACT 
    ( 
     ...
     scanned_image BLOB , 
     is_terminated VARCHAR2 (1) DEFAULT 'N' CHECK ( is_terminated IN ('N', 'Y')) , 
...
CREATE TABLE HOUSE 
    ( 
     ...
     is_reversed VARCHAR2 (1) DEFAULT 'N' CHECK ( is_reversed IN ('N', 'Y')) , 
...
CREATE TABLE HOUSE_SALES_AGENT 
    ( 
     ...
     start_date DATE , 
     end_date DATE , 
     is_main_sales_agent VARCHAR2 (1) DEFAULT 'Y'  NOT NULL CHECK ( is_main_sales_agent IN ('N', 'Y')) , 
