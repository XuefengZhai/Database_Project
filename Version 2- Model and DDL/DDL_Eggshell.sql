...
ALTER TABLE PROJECT_MANAGER 
    ADD CONSTRAINT FK_ASS_177 FOREIGN KEY 
    ( 
     employee_id
    ) 
    REFERENCES EMPLOYEE 
...
ALTER TABLE CREW_MANAGER 
    ADD CONSTRAINT FK_ASS_178 FOREIGN KEY 
    ( 
     employee_id
    ) 
    REFERENCES EMPLOYEE 
...
ALTER TABLE CONSTRUCTION_WORKER 
    ADD CONSTRAINT FK_ASS_179 FOREIGN KEY 
    ( 
     employee_id
    ) 
    REFERENCES EMPLOYEE 
...
ALTER TABLE SALES_AGENT 
    ADD CONSTRAINT FK_ASS_180 FOREIGN KEY 
    ( 
     employee_id
    ) 
    REFERENCES EMPLOYEE 
