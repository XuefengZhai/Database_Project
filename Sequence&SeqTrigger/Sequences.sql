...
CREATE SEQUENCE Emloyee_seq INCREMENT BY 1
START WITH 1;

CREATE SEQUENCE Sales_agent_seq INCREMENT BY 1
START WITH 1;

CREATE SEQUENCE Construction_worker_crew_assignment_seq INCREMENT BY 1
START WITH 1;
...
CREATE SEQUENCE Stage_selected_option_seq INCREMENT BY 1
START WITH 1;
...
CREATE SEQUENCE Crew_project_assighment_seq INCREMENT BY 1
START WITH 1;
...
CREATE SEQUENCE Disclosure_form_assignment_seq INCREMENT BY 1
START WITH 1;
...
CREATE SEQUENCE Subdivision_agreement_assghment_seq INCREMENT BY 1
START WITH 1;
